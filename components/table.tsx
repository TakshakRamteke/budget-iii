        ...
        <>
                    ...
                    renderItem={(record) => (
                        <>
                            <View className='flex flex-row items-center border-slate-600'>
                                <Text
                                    className={`text-white w-48 border-x border-b border-slate-600 p-2 decoration-slate-300 ${record.index === 0
                                ...
                                <Text
                                    className={`text-white w-24 text-right border-r border-b border-slate-600 p-2 px-3 ${record.index === 0
                                            ? 'border-t bg-[#1C1C1C]'
                                            : ''
                                        }`}
                                >
                                ...
                                <Text
                                    className={`text-white w-32 text-center border-r border-b border-slate-600 p-2 capitalize ${record.index === 0
                                            ? 'border-t bg-[#1C1C1C]'
                                            : ''
                                        }`}
                                >
                                ...
                                <Text
                                    className={`text-white w-48 text-right border-r border-b border-slate-600 p-2 ${record.index === 0
            ...
            {paginate && hasToBePaginated ? (
                <View className='flex flex-row my-2 ml-auto border border-slate-600 rounded'>
                    <Pressable
                        className={`p-1 ${canGoBackward ? 'bg-[#1C1C1C]' : 'bg-[#161616]'
                    ...
                    >
                        <Text
                            className={`${canGoBackward ? 'text-white' : 'text-slate-600'
                                }`}
                        >
                            Prev
                        </Text>
                    ...
                    <Pressable
                        className={`p-1 ${canGoForward ? 'bg-[#1C1C1C]' : 'bg-[#161616]'
                            } rounded-sm px-4`}
                        onPress={() => {
                            if (canGoForward) {
                    ...
                    >
                        <Text
                            className={`${canGoForward ? 'text-white' : 'text-slate-600'
                                }`}
                        >
                            Next
                        </Text>
